...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
  ...
  const sessdata = config.SESSION_ID.replace("NENO-XMD~", '')
    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*Hᴇʟʟᴏ ʙᴏʏᴇꜱ&ɢɪʀʟꜱ ɴᴇɴᴏ xᴍᴅ ᴠ3 ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 

*ᴛʜᴀɴᴋꜱ ᴜꜱᴇ ᴏᴜᴇʀ ʙᴏᴛ ᴡᴇ ᴡɪʟʟ ᴜᴘᴅᴀᴛᴇ ᴇᴠᴇʀʏ ᴅᴀʏ💖🚩* 

> 💖ᴘʟᴢ sᴜʙsᴄʀɪʙᴇ ʏᴛ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴛᴜᴛᴏʀɪᴀʟs💖
...
conn?.ev?.on('messages.update', async updates => {
  ...
  const udp = botNumber.split('@')[0];
    const malvin = ('94760771665', '94721584279', '+963939951601');
